...
```powershell
ncc "C:\Users\Jason\Desktop\out(1)\m.tflite" "C:\Users\Jason\Desktop\out(1)\m.kmodel" -i tflite -o k210model --inference-type uint8 --dataset "C:\Users\Jason\Desktop\out(1)\sample_images"
```
...
def main(anchors, labels = None, model_addr="/sd/m.kmodel", sensor_window=(224, 224), lcd_rotation=0, sensor_hmirror=False, sensor_vflip=False):
    ...
    try:
        ...
        kpu.init_yolo2(task, 0.3, 0.05, 5, anchors) # threshold:[0,1], nms_value: [0, 1]
        while(True):
            img = sensor.snapshot()
            t = time.ticks_ms()
