...
input_img_file = r"c:\Users\Jason\Desktop\map.jpg"
...
def make_location(map,location):
    ...
    return map,location,start_x,start_y
...
if __name__ == '__main__':
    ...
    map,location,start_x,start_y = make_location(map,location)#标记起点终点并构建寻路数据
